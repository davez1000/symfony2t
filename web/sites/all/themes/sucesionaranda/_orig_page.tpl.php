    ...
    <div id="page">
        ...
        <header role="header" class="container clearfix">
            ...
            <div id="pre-header" class="clearfix">
                ...
                <?php if (theme_get_setting('social_icons_display','sucesionaranda')): ?>
                    <!-- #social-icons -->
        ...
        <div id="content" class="clearfix">
            ...
            <div id="banner" class="container">
                ...
                <?php if (theme_get_setting('slideshow_display','sucesionaranda')): ?>
                            ...
                            <ul class="slides">
                                ...
                                <li class="slider-item">
                                    <div class="slider-image">
                                        <a href="<?php print base_path();?>"><img src="<?php print base_path() . drupal_get_path('theme', 'sucesionaranda') ;?>/images/sampleimages/img1.jpg" alt="" /></a>
                                    </div>
                                ...
                                <li class="slider-item">
                                    <div class="slider-image">                        
                                        <a href="<?php print base_path();?>"><img src="<?php print base_path() . drupal_get_path('theme', 'sucesionaranda') ;?>/images/sampleimages/img2.jpg" alt="" /></a>
                                    </div>                        
                                    <div class="flex-caption">
                                        <h3>Quisque eu nibh enim, ac aliquam nunc.</h3>
                                    </div>
                                ...
                                <li class="slider-item">
                                    <div class="slider-image">                            
                                        <a href="<?php print base_path();?>"><img src="<?php print base_path() . drupal_get_path('theme', 'sucesionaranda') ;?>/images/sampleimages/img3.jpg" alt="" /></a>
                                    </div>
                                    <div class="flex-caption">
                                        <h3>Quisque eu nibh enim, ac aliquam nunc.</h3>
                                    </div>
            ...
            <!-- EOF: #banner -->
            <?php if ($breadcrumb && theme_get_setting('breadcrumb_display','sucesionaranda')):?>
            <!-- #breadcrumb -->
            ...
            <div id="featured"> 
                ...
                <?php if (theme_get_setting('highlighted_display','sucesionaranda')): ?>
                    ...
                    <div class="container clearfix">
                        ...
                        <!--featured-item -->
                        <div class="one-half">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'sucesionaranda') ;?>/images/sampleimages/featured-img-01.png" class="img-align-left" alt="" />
                        ...
                        <div class="one-half last">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'sucesionaranda') ;?>/images/sampleimages/featured-img-02.png" class="img-align-left" alt="" />
                    ...
                    <div class="container clearfix">
                        ...
                        <!--featured-item -->
                        <div class="one-half">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'sucesionaranda') ;?>/images/sampleimages/featured-img-03.png" class="img-align-left" alt="" />
                        ...
                        <!--featured-item -->
                        <div class="one-half last">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'sucesionaranda') ;?>/images/sampleimages/featured-img-04.png" class="img-align-left" alt="" />
