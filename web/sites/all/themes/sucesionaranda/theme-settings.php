 ...
 *   The form state.
 */
function sucesionaranda_form_system_theme_settings_alter(&$form, &$form_state) {
    ...
    $form['mtt_settings']['tabs']['looknfeel']['theme_colors']['theme_color'] = array(
        ...
        '#default_value' => theme_get_setting('theme_color','sucesionaranda'),
        '#options' => array(
            'default' => t('Default'),
    ...
    $form['mtt_settings']['tabs']['looknfeel']['buttons']['button_color'] = array(
        ...
        '#title' => t('Colors'),
        '#description'   => t('From the drop-down menu, select the color scheme you prefer.'),
        '#default_value' => theme_get_setting('button_color','sucesionaranda'),
        '#options' => array(
            'blue' => t('Blue'),
    ...
    $form['mtt_settings']['tabs']['plugins']['header_tooltip']['social_icons_display'] = array(
        ...
        '#description'   => t('Use the checkbox to enable or disable the Social Icons inside the header [<em>sucesionaranda/page.tpl.php</em>].'),
        '#default_value' => theme_get_setting('social_icons_display','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['header_tooltip']['header_tooltip_js'] = array(
        ...
        '#description'   => t('Use the checkbox to include or not the javascript tipsy.js library for the Social Icons Tooltips [<em>sucesionaranda/js/plugins/jquery.tipsy.js</em>].<br> More info <a href="http://onehackoranother.com/projects/jquery/tipsy/" target="_blank">http://onehackoranother.com/projects/jquery/tipsy</a>.'),
        '#default_value' => theme_get_setting('header_tooltip_js','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['main_menu']['main_menu_custom_js'] = array(
        ...
        '#default_value' => theme_get_setting('main_menu_custom_js','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['slideshow']['slideshow_display'] = array(
        ...
        '#description'   => t('Use the checkbox to enable or disable the front-page Slideshow [<em>sucesionaranda/page.tpl.php</em>].'),
        '#default_value' => theme_get_setting('slideshow_display','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['slideshow']['slideshow_js'] = array(
        ...
        '#default_value' => theme_get_setting('slideshow_js','sucesionaranda'),
    );    
    ...
    $form['mtt_settings']['tabs']['plugins']['slideshow']['slideshow_effect'] = array(
        ...
        '#default_value' => theme_get_setting('slideshow_effect','sucesionaranda'),
        '#options' => array(
        'slide' => t('Slide'),
        'fade' => t('Fade'),
        ),
    ...
    $form['mtt_settings']['tabs']['plugins']['highlighted']['highlighted_display'] = array(
        ...
        '#description'   => t('Use the checkbox to enable or disable the front-page Featured content [<em>sucesionaranda/page.tpl.php</em>].'),
        '#default_value' => theme_get_setting('highlighted_display','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_display'] = array(
        ...
        '#default_value' => theme_get_setting('carousel_display','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_js'] = array(
        ...
        '#default_value' => theme_get_setting('carousel_js','sucesionaranda'),
    );

    $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_effect_time'] = array(
        '#type' => 'textfield',
        '#title' => t('Effect duration (sec)'),
        '#default_value' => theme_get_setting('carousel_effect_time','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_effect'] = array(
        ...
        '#default_value' => theme_get_setting('carousel_effect','sucesionaranda'),
        '#options' => array(
            'linear' => 'linear',
            'swing' => 'swing',
    ...
    $form['mtt_settings']['tabs']['plugins']['quicksand']['quicksand_js'] = array(
        ...
        '#description'   => t('Use the checkbox to include or not the quicksand javascript code in order to reorder and filter portofolio items with a nice shuffling animation [<em>sucesionaranda/js/plugins/quicksand.js</em> & <em>sucesionaranda/js/plugins/quicksand_initialize.js</em>]. <br>More info <a href="http://razorjack.net/quicksand/" target="_blank">http://razorjack.net/quicksand</a>.'),
        '#default_value' => theme_get_setting('quicksand_js','sucesionaranda'),
    );    
    ...
    $form['mtt_settings']['tabs']['plugins']['prettyphoto']['prettyphoto_js'] = array(
        ...
        '#description'   => t('Use the checkbox to include or not the prettyPhoto javascript and css code in order to overlay images on the current page [<em>sucesionaranda/js/plugins/jquery.prettyPhoto.js</em> & <em>sucesionaranda/css/plugins/prettyPhoto.css</em>]. <br>More info <a href="http://www.no-margin-for-errors.com/projects/prettyphoto-jquery-lightbox-clone/" target="_blank">http://www.no-margin-for-errors.com/projects/prettyphoto-jquery-lightbox-clone</a>.'),
        '#default_value' => theme_get_setting('prettyphoto_js','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['prettyphoto']['prettyphoto_theme'] = array(
        ...
        '#default_value' => theme_get_setting('prettyphoto_theme','sucesionaranda'),
        '#options' => array(
    ...
    $form['mtt_settings']['tabs']['plugins']['prettyphoto']['prettyphoto_social_tools'] = array(
        ...
        '#default_value' => theme_get_setting('prettyphoto_social_tools','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['plugins']['jtweetanywhere']['jtweetanywhere_id'] = array(
        ...
        '#default_value' => theme_get_setting('jtweetanywhere_id','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['shortcodes']['columns']['columns_enable'] = array(
        '#type' => 'checkbox',
        '#title' => t('Include css file for custom grid [<em>sucesionaranda/css/shortcodes/columns.css</em>].'),
        '#default_value' => theme_get_setting('columns_enable','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['shortcodes']['boxes']['boxes_enable'] = array(
        '#type' => 'checkbox',
        '#title' => t('Include css file for additional message styles [<em>sucesionaranda/css/shortcodes/boxes.css</em>].'),
        '#default_value' => theme_get_setting('boxes_enable','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['shortcodes']['lists']['lists_enable'] = array(
        '#type' => 'checkbox',
        '#title' => t('Include css file for additional lists styles [<em>sucesionaranda/css/shortcodes/lists.css</em>].'),
        '#default_value' => theme_get_setting('lists_enable','sucesionaranda'),
    );
    ...
    $form['mtt_settings']['tabs']['breadcrumb']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','sucesionaranda'),
    );

    $form['mtt_settings']['tabs']['breadcrumb']['breadcrumb_separator'] = array(
        '#type' => 'textfield',
        '#title' => t('Breadcrumb separator'),
        '#default_value' => theme_get_setting('breadcrumb_separator','sucesionaranda'),
        '#size'          => 5,
        '#maxlength'     => 10,
    );
	...
	$form['mtt_settings']['tabs']['support']['responsive']['responsive_menu']['responsive_menu_state'] = array(
		...
		'#default_value' => theme_get_setting('responsive_menu_state', 'sucesionaranda'),
	);
	...
	$form['mtt_settings']['tabs']['support']['responsive']['responsive_menu']['responsive_menu_switchwidth'] = array(
		...
		'#default_value' => theme_get_setting('responsive_menu_switchwidth', 'sucesionaranda'),
	);
	...
	$form['mtt_settings']['tabs']['support']['responsive']['responsive_menu']['responsive_menu_topoptiontext'] = array(
		...
		'#default_value' => theme_get_setting('responsive_menu_topoptiontext', 'sucesionaranda'),
	);
    ...
    $form['mtt_settings']['tabs']['support']['responsive']['responsive_meta'] = array(
        ...
        '#default_value' => theme_get_setting('responsive_meta','sucesionaranda'),
    );

    $form['mtt_settings']['tabs']['support']['responsive']['responsive_respond'] = array(
        '#type' => 'checkbox',
        '#title' => t('Add Respond.js [<em>sucesionaranda/js/respond.min.js</em>] JavaScript to add basic CSS3 media query support to IE 6-8.'),
        '#default_value' => theme_get_setting('responsive_respond','sucesionaranda'),
