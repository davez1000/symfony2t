            ...
            <div id="pre-header" class="clearfix">
                ...
                <?php if (theme_get_setting('social_icons_display','sucesionaranda')): ?>
                    ...
                    <div id="social-icons" class="clearfix">
                        <ul id="social-links">
                            <li class="facebook-link"><a href="https://www.facebook.com/asdfasdfasdfasdfasdfasdfasdf" class="facebook" id="social-01" title="Join Us on Facebook!">Facebook</a></li>
                            <li class="twitter-link"><a href="https://twitter.com/asdfadfasdfasdfasdfasdf" class="twitter" id="social-02" title="Follow Us on Twitter">Twitter</a></li>
        ...
        <div id="content" class="clearfix">
            ...
            <div id="bottom-content" class="container clearfix">
                ...
                <?php if (theme_get_setting('carousel_display','sucesionaranda')): ?>
					...
					<?php //if ($is_front): ?>
          <?php $asdfasdfasdfasdfa = FALSE; ?>
					<?php if ($asdfasdfasdfasdfa): ?>
